...
pause
::  j'y ai cru ; je me suis acharn ...et pi non
...
:: REG DELETE "HKEY_CURRENT_USER\Software\Classes\.pdf\OpenWithProgids" /v "(par dfaut)" /f
chcp 1252>NUL
:: et voila c'est a qui fallait faire !!
